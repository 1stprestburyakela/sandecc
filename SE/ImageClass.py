...
template = """<img src="Images/%s" class="slide" alt="Slide 1" data-trans="setTimeout(function(){transition();}, 8000)"/>"""
def deploy(config):
    #try:
        ...
        if "resized"+newFilename not in alreadydone:
            ...
            os.system("magick \""+fullpath+"\" -auto-orient -resize 1920x1080 \"Deployed\\Images\\resized"+newFilename+"\"" )
			
        return template % ("resized"+newFilename)
    #except:
        return ""
