...
function slideShow() {
  ...
  setTimeout(initializeSlideShowMarkup,1000);
  ...
  function initializeGlobals() {   
    ...
    if (globals.wrapperObject) {
      globals.slideImages = (globals.wrapperObject.querySelectorAll('img.slide,div.slide,video.slide') ? globals.wrapperObject.querySelectorAll('img.slide,div.slide,video.slide') : []);
    }
  } // initializeGlobals
  ...
  function transitionSlides() {
    ...
    // Call the new slide's transition mechanism
    console.log(nextSlide.getAttribute("data-trans"));
    f = new Function(nextSlide.getAttribute("data-trans"));
    f();
   // eval(nextSlide.getAttribute("data-trans"));
